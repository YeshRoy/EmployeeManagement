...
public class EmployeeController {
	...
	public ResponseEntity<?> addEmployee(@RequestBody Employee employee) {
		...
		return ResponseEntity.ok(new ResponseMessage(true, HttpStatus.INTERNAL_SERVER_ERROR,"Employee Is Not Added Successfully"));
	}
	...
	public ResponseEntity<?> updateEmployee(@RequestBody Employee employee,@PathVariable long id) {
		...
		return ResponseEntity.ok(new ResponseMessage(true, HttpStatus.INTERNAL_SERVER_ERROR,"Employee Is Not Updated Successfully"));
	}
